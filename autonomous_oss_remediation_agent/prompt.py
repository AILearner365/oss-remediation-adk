...
- Before final selection, challenge whether the leading candidate is merely workable or is the strongest project-fit solution reasonably supported by the available evidence. If a materially unresolved decision issue remains and reasonably obtainable investigation could materially change selection, investigate and reconsider before committing; otherwise proceed without requiring exhaustive exploration or proof of a global optimum.
